...
Of 80 terms with a strong monotonic trend (|ρ| ≥ 0.5) across 2007–2023, the draft **reverses 55**. **This number requires its control and largely fails it.** Holding out any single document and scoring it by the same rule: the annual-update plans of 2009–2013 reverse 75–79 of 80, SP-2017 59, the draft 55, SP-2019 50, SP-2023 38, SOA-2023 36, RTC-2023 33. A trend fitted across 45 documents and then scored against a group mean, with no minimum size of change, fires on almost any document; 11 of the draft's 55 reversals are terms it simply never uses and 13 have a 2018+ base rate under 2 per 10,000 words. The defensible claim is that the draft reverses more than any other post-2018 document (SP-2019: 50, SP-2023: 38) while reversing fewer than every plan from 2009 to 2017, not that 55/80 is itself anomalous.
